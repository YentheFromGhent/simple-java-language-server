...
/** will read constantly from stdin looking from rpc-message */
public class StdInRpcMessasgeReader implements RequestReader {

    private static final Logger LOGGER = Logger.getLogger("reader");

    public StdInRpcMessasgeReader() {
    ...
    public byte[] nextMessage() throws IOException {
        ...
        while (true) {
            ...
            //this is necesarry, if we had no bytes read, and the remaing stored bytes did not contain a content.
